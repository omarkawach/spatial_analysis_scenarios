...
3. Open a console where you have cloned the repo, install all necessary python packages in one go by using:
...
For an automated approach to proximity analysis in topology, one could take a collection of Voronoi (Thiessen) polygons and divide them by their distance to a point. [Voronoi Methods in GIS](http://citeseerx.ist.psu.edu/viewdoc/download?doi=10.1.1.86.3356&rep=rep1&type=pdf)
